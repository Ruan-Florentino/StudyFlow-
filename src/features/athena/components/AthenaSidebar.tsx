      ...
      {shouldShow ? (
        <>
          ...
          <motion.div
            ...
            className={
              'athena-sidebar-panel athena-floating-chat-panel fixed z-[1200] flex flex-col overflow-hidden rounded-[28px] border shadow-2xl outline-none ' +
              (expanded
          ...
          >
            <div className="athena-chat-header athena-floating-window-header flex shrink-0 items-center justify-between gap-3 p-4 backdrop-blur-xl">
              <div className="flex min-w-0 items-center gap-3">
                ...
                <div className="min-w-0">
                  ...
                  <p className="flex items-center gap-1.5 truncate text-[10px] font-bold uppercase tracking-widest text-white/45">
              ...
              <div className="flex shrink-0 items-center gap-2">
                <motion.button
                  ...
                  whileTap={{ scale: 0.94 }}
                  className="athena-window-action rounded-2xl p-2 text-white/60 transition-colors"
                  title={expanded ? 'Reduzir janela' : 'Ampliar janela'}
                  aria-label={expanded ? 'Reduzir janela' : 'Ampliar janela'}
                >
                ...
                <motion.button
                  ...
                  onClick={closeChat}
                  whileTap={{ scale: 0.94 }}
                  className="athena-window-action rounded-2xl p-2 text-white/60 transition-colors hover:border-red-400/25 hover:bg-red-500/10 hover:text-red-300"
                  title="Fechar Athena"
                  aria-label="Fechar Athena"
                >
                  <X size={18} />
