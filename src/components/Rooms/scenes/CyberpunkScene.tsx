      ...
      <svg className="w-full h-full" viewBox="0 0 1000 1000" preserveAspectRatio="xMidYMid slice">
        ...
        {[...Array(40)].map((_, i) => (
          <motion.rect
            ...
            transition={{ duration: 2 + Math.random() * 5, repeat: Infinity, delay: Math.random() * 10 }}
          />
        ))}

        {/* Letreiros Neon */}
        <motion.g animate={{ opacity: [1, 0.8, 0.9, 0.4, 1] }} transition={{ duration: 0.2, repeat: Infinity, repeatDelay: 5 }}>
          <rect x="400" y="420" width="60" height="20" fill="none" stroke="#ec4899" strokeWidth="2" />
          <text x="405" y="435" fill="#ec4899" fontSize="12" fontWeight="bold">CAFÉ</text>
        </motion.g>

        <motion.g animate={{ opacity: [1, 0.7, 1] }} transition={{ duration: 3, repeat: Infinity }}>
          <rect x="130" y="470" width="20" height="80" fill="none" stroke="#06b6d4" strokeWidth="2" />
          <text x="135" y="490" fill="#06b6d4" fontSize="14" style={{ writingMode: 'vertical-rl' }}>ネオン</text>
        </motion.g>
